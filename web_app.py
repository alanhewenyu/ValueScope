...
with st.sidebar:
    ...
    _sponsor_label = t('sidebar_sponsor')
    with st.container(key="vs_sidebar_footer"):
        st.markdown(
            ...
            f'    <div><a href="https://buymeacoffee.com/alanhe" target="_blank" style="color:#e8a023;text-decoration:none;font-weight:600;">☕ {_sponsor_label}</a></div>'
