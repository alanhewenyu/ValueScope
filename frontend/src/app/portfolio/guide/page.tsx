...
若反过来先更新份额再定价：涨幅被摊薄成 +1.8% —— 新钱凭空分走老钱的收益，错。`}</Code>
      ...
      <P>
        摊薄口径（国内券商/富途）：跟着改，照抄券商新成本即可。此时股价降 1 元、成本也降 1 元，个股浮盈和 YTD 归因都不变——股息的贡献只体现在净值层面，不会重复计入个股归因，口径自洽。平均口径（盈透）：成本不动，个股归因会显示除权那一跌、股息落在净值层面——分红股在个股归因表里显得偏弱是口径特性，不是错。
      </P>
