...
若反过来先更新份额再定价：涨幅被摊薄成 +1.8% —— 新钱凭空分走老钱的收益，错。`}</Code>
      ...
      <P>
        摊薄口径（国内券商/富途）：跟着改，照抄券商新成本即可。此时股价降 1 元、成本也降 1 元，个股浮盈和 YTD 归因都不变——股息的贡献只体现在净值层面，不会重复计入个股归因，口径自洽。平均口径（盈透）：普通股息成本不动、记为收入，个股归因会显示除权那一跌、股息落在净值层面——分红股在个股归因表里显得偏弱是口径特性，不是错。例外：被归类为「资本返还」（Return of Capital，常见于 REITs/房托/封闭式基金的部分分配）的分配在盈透也会调减成本——那是税务分类而非口径惯例，报表里单独标注，跟着券商改即可。
      </P>
